...
server
    ...
    .post('/banInGroup', (0, cookie_parser_1.default)(), express_1.default.json(), middleware_1.checkAdminPermission, index_1.banInGroup, middleware_1.errorOut)
    .post('/banInChat', (0, cookie_parser_1.default)(), express_1.default.json(), middleware_1.checkAdminPermission, index_1.banInChat, middleware_1.errorOut)
    .post('/ubBanInChat', (0, cookie_parser_1.default)(), express_1.default.json(), middleware_1.checkAdminPermission, index_1.unBanInChat, middleware_1.errorOut)
    ...
    .post('/addToGroup', (0, cookie_parser_1.default)(), express_1.default.json(), middleware_1.checkUserPermission, index_1.addToGroup, middleware_1.errorOut)
    .post('/delFromGroup', (0, cookie_parser_1.default)(), express_1.default.json(), middleware_1.checkUserPermission, index_1.delFromGroup, middleware_1.errorOut)
